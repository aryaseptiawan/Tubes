@extends('layouts.app')
@section('title', 'Tipe Transportasi Maskapai')
@section('heading', 'Tipe Transportasi Maskapai')
@section('styles')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tambah Tipe Transportasi</h5>
          <button
            type="button"
            class="close"
            data-dismiss="modal"
