...
<head>
  ...
  <title>Ticket Penerbangan - @yield('title')</title>
            ...
            <div class="container my-auto">
              <div class="copyright text-center my-auto">
                <span>
                  ...
                  <a href="https://github.com/polinema-web-basic/TugasBesar_Alvi-Arya.git" target="_blank"
                    >Alvi Rahmadhani & Arya Septiawan
                    </a
                  >.
                </span>
              </div>
        ...
        <nav class="navbar navbar-expand navbar-light topbar mb-4">
          <div class="container">
            <a class="title" href="{{ url('/') }}">
              ...
              <div class="title-text mx-3">Ticket Penerbangan</div>
            </a>
            <!-- Topbar Navbar -->
